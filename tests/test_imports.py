...
def test_basic_alignment_smoke():
    ...
    df = pd.DataFrame(
            {
                ...
                "Age groups / 0 to 14 years / %": [0.18, 0.12, 0.22],
    ...
    out = evaluate_flexd_alignment(
        df,
        column_map={
            "full_time": "Labour force status / Worked full-year, full-time in 2020 / 25% sample data",
            "not_in_labour_force": "Labour force status / Not in the labour force / 25% sample data",
            "children": "Age groups / 0 to 14 years / %",
            "single_parent": "Census families / One-parent census families / %",
            "commute_burden": "Commuting duration / 60 minutes and over / %",
            "household_size": "Occupied private dwellings / Average household size",
            "occupancy_density": "Occupied private dwellings / Average number of persons per room",
            "tenure_owner": "Tenure / Owner",
            "peak_intensity": "winter_peak_intensity",
            "peak_to_mean_ratio": "am_pm_peak_ratio",
            "heating_slope": "heating_slope_per_hdd",
        },
    )
